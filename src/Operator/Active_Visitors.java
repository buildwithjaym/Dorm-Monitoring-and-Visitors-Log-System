 ...
 * @author admin
 */
public class Active_Visitors extends javax.swing.JFrame {

    /**
     * Creates new form Active_Visitors
     */
    public Active_Visitors() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/white_1.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/10.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(943, 565));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Active_Visitors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Active_Visitors().setVisible(true);
            }
        });
    }
